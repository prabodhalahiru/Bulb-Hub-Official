...
import com.example.bulbhub.Bulb.Cart;
import com.example.bulbhub.Pbulb.Prevalent;
import com.example.bulbhub.ViewHolder.CartViewHolder;
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //small part 8 there was int i but now int which
                                if(which == 0){
                                    Intent intent = new Intent(CartActivity.this, ProductDetailsActivity.class);
                                    intent.putExtra("pid", model.getPid()); //model made as final
                                    startActivity(intent);
                                }
                                if(which == 1){
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if(task.isSuccessful()){
                                                        ...
                                                        Intent intent = new Intent(CartActivity.this, MazdaActivity.class);
                                                        startActivity(intent);
                                                    }
                                                }
                                            });
