        ...
        CreateAccountButton.setOnClickListener(new View.OnClickListener() {
            ...
            private void CreateAccount() {
                ...
                if(TextUtils.isEmpty(name)){
                    Toast.makeText(getApplicationContext(),"Please Input a User Name",Toast.LENGTH_SHORT).show();
                        ...
                        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if(!(dataSnapshot.child("users").child(phone).exists())){
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if(task.isSuccessful()){
                                                        Toast.makeText(RegisterActivity.this,"Successfully Created Your Account",Toast.LENGTH_SHORT).show();
                                                        loadingBar.dismiss();
                                    ...
                                    Toast.makeText(RegisterActivity.this,"Already exists"+phone+"try another",Toast.LENGTH_SHORT).show();
                                    loadingBar.dismiss();
