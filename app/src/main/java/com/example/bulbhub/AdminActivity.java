...
public class AdminActivity extends AppCompatActivity {
    ...
    private void ValidateProductData(){
        ...
        if (ImageUri == null){
            ...
            Toast.makeText(this,"Write a Product Description",Toast.LENGTH_SHORT).show();

        }
        else if(TextUtils.isEmpty(Price)){
            Toast.makeText(this,"Enter a Product Price",Toast.LENGTH_SHORT).show();
        }
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AdminActivity.this,"Got Product Url",Toast.LENGTH_SHORT).show();
